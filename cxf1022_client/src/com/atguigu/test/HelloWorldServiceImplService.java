 ...
 * 
 */
@WebServiceClient(name = "HelloWorldServiceImplService", targetNamespace = "http://test.atguigu.com/", wsdlLocation = "http://localhost:9999/cxf1022_server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICEIMPLSERVICE_QNAME = new QName("http://test.atguigu.com/", "HelloWorldServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/cxf1022_server?wsdl");
    ...
    public HelloWorld getHelloWorldServiceImplPort() {
        return super.getPort(new QName("http://test.atguigu.com/", "HelloWorldServiceImplPort"), HelloWorld.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldServiceImplPort")
    public HelloWorld getHelloWorldServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.atguigu.com/", "HelloWorldServiceImplPort"), HelloWorld.class, features);
    }
