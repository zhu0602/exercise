 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://test.auguigu.com/", wsdlLocation = "http://localhost:9999/weather?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9999/weather?wsdl");
